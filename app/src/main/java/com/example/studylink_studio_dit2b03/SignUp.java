...
//        AlertDialog.Builder getInstitution = new AlertDialog.Builder(SignUp.this);
//
...
//                // Get institution names from Firebase
//                Iterable<DataSnapshot> children = dataSnapshot.getChildren();
//                ArrayAdapter<String> institutionArr = new ArrayAdapter<>(SignUp.this, android.R.layout.simple_spinner_dropdown_item);
//                for (DataSnapshot child : children) {
//                    String institutionName = child.child("name").getValue(String.class);
//                    Log.d("all institution",institutionName);
//                    institutionArr.add(institutionName);
//                }
//
//                institutionDropdown.setAdapter(institutionArr);
//
...
//                                Toast.makeText(getApplicationContext(), "Institution selection canceled", Toast.LENGTH_SHORT).show();
//                            }
//                        })
//                        .show();
//            }
...
//                Log.e("Firebase", "Error loading institutions", databaseError.toException());
...
//        AlertDialog.Builder getCourse = new AlertDialog.Builder(SignUp.this);
//
//        final Spinner coursenDropdown = new Spinner(this);
//
...
//                // Get institution names from Firebase
//                Iterable<DataSnapshot> children = dataSnapshot.getChildren();
//                ArrayAdapter<String> courseArr = new ArrayAdapter<>(SignUp.this, android.R.layout.simple_spinner_dropdown_item);
//                for (DataSnapshot child : children) {
//                    String courseName = child.child("name").getValue(String.class);
//                    Log.d("all courseName",courseName);
//                    courseArr.add(courseName);
//                }
//
//                coursenDropdown.setAdapter(courseArr);
//
//                getCourse.setView(coursenDropdown)
...
//                                // Store the selected institution
//
//                                course = coursenDropdown.getSelectedItem().toString();
//                                Log.d("institution",course);
//                                // Show the next dialog
//                                signUpUser(sEmail,sPwd);
//                            }
//                        }) .setOnCancelListener(new DialogInterface.OnCancelListener() {
